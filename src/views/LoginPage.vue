		...
		login: function() {
			...
			let res = {
				...
				data: {
					userId: 'oldeng',
					token:
						'eyJhbGciOiJIUzI1NiJ9..oEjCTOh36-9aCYUF6nB5zTmetN2sWwnAM7nZ0EHfMDs'
				}
			};
			let data = {
				userId: 'oldeng'
